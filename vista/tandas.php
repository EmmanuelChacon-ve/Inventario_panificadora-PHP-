...
<body>
    ...
    <div class="table-product">
            ...
            <?php
                ...
                while ($row = mysqli_fetch_array($query)) { ?>
                    <tr>
                        ...
                        <td class="modify"><a name="edit" id="" class="bfix" href="./edit/editan.php?id=<?php echo $row['id_tan'] ?>&fecha=<?php echo $row['fec_tan'] ?>&pan=<?php echo $row['id_pan'] ?>&cantidad=<?php echo $row['can_pie'] ?>" role="button">
                        ...
                        <td class="delete"><a name="id" id="" class="bdelete"  href="../controlador/delete/deletetan.php?id=<?php echo $row['id_tan'] ?>" role="button">
        ...
        <br>
        <a name="" id="" class="Addlist" style="float:right" href="./add/addtan.php" role="button">Agregar Producto</a>
    </div>
    <?php
    mysqli_close($conn);
    ?>
