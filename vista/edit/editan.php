...
<header class="header" >
    ...
    <div class="table-product">
        ...
        <div class="addproduct">
            <form method="POST" action="../../controlador/edit/editan.php">
            <div class="form-group">
                <label for="exampleInputEmail1">fecha</label>
                <br>
                <input type="text" class="form-control" name="fecha" value="<?php echo $_GET['fecha']; ?>" onblur="espacioBlanco(value,this)">
               
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">Id del pan</label>
                <br>
            ...
            <div class="form-group">
                ...
                <br>
                <input type="text" class="form-control" name="cantidad" value="<?php echo $_GET['cantidad']; ?>" onblur="validacion2(value,this)">
                ...
                <div class="form-button">
                    ...
                    <button type="submit" class="modify" style="float:right">Editar Tanda</button>
